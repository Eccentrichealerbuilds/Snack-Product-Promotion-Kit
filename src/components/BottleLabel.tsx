...
export const BottleLabel = () => {
  ...
  const handleDownload = async () => {
    if (labelRef.current) {
      ...
      link.download = "adukes-treats-bottle-label.png";
      link.href = dataUrl;
      link.click();
    }
  };
  const handleDownload4K = async () => {
    if (labelRef.current) {
      ...
      const link = document.createElement('a');
      link.download = "adukes-treats-bottle-label-4k.png";
      link.href = dataUrl;
      link.click();
    }
  };
  ...
  return (
    <div className="w-full max-w-[300px] mx-auto">
      <div ref={labelRef} className="overflow-hidden rounded-lg shadow-lg">
